;;; ~/.config/doom/splash.el -*- lexical-binding: t; -*-

;; @val0r kindly made a black hole logo for doom discord
;; @tecosaur wrote these settings to auto-resize it
;; And I modified it to spacegrey colors cause I like spacegrey. The original
